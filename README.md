...
- **Monte Carlo Simulations:** simulating the **Ising Model** Phase-Transition for liquid-gas and ferromagnetic systems. Different approaches were followed: single spin flip Hastings algorithm, Swendsen-Wang Cluster algorithm with Improved Estimators in Fortuin and Kasteleyn representation.
